...
var countArray = function(array) {   //[1, [2, [3,4]], [5,6], 7]    [5, 6]
    //                                     i
    // Tu código aca:
    let suma = 0;// suma = 21
...
var mergeQueues = function(queueOne, queueTwo) {
    ...
    while(queueOne.size() || queueTwo.size()) {
        let one = queueOne.dequeue() // shift()
        let second = queueTwo.dequeue()

        // if(oneQueue) {
        //     newQueue.enqueue(oneQueue) // push
        // }
        // if(secondQueue) {
        //     newQueue.enqueue(secondQueue)
        // }
        if(one) newQueue.enqueue(one) // push
...
BinarySearchTree.prototype.sum = function() {
    // Tu código aca:
    // if(!this.left && !this.right) return this.value; //nodo raiz
